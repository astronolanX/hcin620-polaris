...
- Keep Jira ticket references (IDs, links, and ticket-specific status notes) only in commit titles/bodies or pull request titles/descriptions. Do not include them in repository files, filenames, code comments, or site content. General references to Jira as a workflow tool are allowed.
