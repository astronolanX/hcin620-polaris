export const stakeholders = [
  ...
  {
    name: 'Environmental conservationists',
    goals: 'Encourage safer e-waste disposal and educate people about the dangers it can cause.',
    concerns: 'Some companies may handle e-waste in ways that are unsafe or harmful to the environment.',
    involvement: 'Learn what e-waste problems they see most often and what information people need. Also, ask them to review if the platform promotes safe and responsible disposal.',
  },
] as const;
