...
Work is assigned during weekly team meetings based on members' skills, preferences, availability, and project needs.
...
- Create a branch from `main` for each focused change.
